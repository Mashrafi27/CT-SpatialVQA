#!/usr/bin/env python3
"""Preprocess CT NIfTI volumes for MedEvalKit (Lingshu/Qwen2.5-VL).

Creates .npz files with pre-rendered RGB slices using CT windows.
Pipeline mirrors benchmarking/inference/medevalkit/run_custom_eval.py:
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Preprocess NIfTI for MedEvalKit")
...
def main() -> None:
    ...
    for rec in tqdm(records, desc="Preprocess MedEvalKit"):
